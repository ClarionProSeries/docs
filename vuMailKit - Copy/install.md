---
title: "vuMailKit - Installation"
summary: "When you run the installer for vuMailKit it locates valid Clarion installations on your computer and lets you choose which one to install the template for."
description: "When you run the installer for vuMailKit it locates valid Clarion installations on your computer and lets you choose which one to install the template for."
keywords: ["Clarion", "install", "vuMailKit", "installation", "installer", "templates", "setup", "email"]
page_type: "guide"
