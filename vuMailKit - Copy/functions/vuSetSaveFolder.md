...
description: "Legacy vuMail function name. This function is an alias for vuGlobalsSetEmailFolder() and behaves identically. Use vuGlobalsSetEmailFolder() for new development. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
...
```Prototype
vuSetSaveFolder(*CSTRING InFolder),SIGNED,PROC,PASCAL,RAW,NAME('vuSetSaveFolder')
```
