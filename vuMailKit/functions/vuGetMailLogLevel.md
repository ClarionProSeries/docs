...
summary: "Legacy alias for vuGetDiagnosticsLevel(); gets diagnostics verbosity."
description: "Legacy-compatible alias for vuGetDiagnosticsLevel(). This reports diagnostics verbosity only, not the sent-mail CSV log."
keywords: ["vuMailKit", "vuMail", "vugetmailloglevel", "vugetdiagnosticslevel", "diagnostics", "trace"]
