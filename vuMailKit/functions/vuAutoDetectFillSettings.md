---
title: "vuAutoDetectFillSettings"
summary: "Auto-detect provider settings from an email address and fill writable output buffers with the recommended values. This legacy-compatible entry now runs the full deep-scan pipeline."
function_name: "vuAutoDetectFillSettings"
category: "Autodetect"
...
Result = vuAutoDetectFillSettings(EmailAddress, BufLen, ProfileEmail, |
...
- This function is designed for the vuMailKit Email Setup Wizard and first-run configuration screens.
