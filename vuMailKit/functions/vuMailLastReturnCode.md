...
description: "Returns the numeric status code for the most recent completed send operation. [Home](../index.md) | [All functions](index.md) | [Categories](../categories/index.md)"
