...
description: "Saves a named attachment from the loaded POP3 message into the configured POP3 folder. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
