...
description: "Legacy email-address parsing helper retained for compatibility."
...
**Prototype:** vuExtractMailAddr(*CSTRING InText), CSTRING, PROC, PASCAL, RAW, NAME('vuExtractMailAddr')
