...
description: "Imports only message headers from an .eml file into the legacy session. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
