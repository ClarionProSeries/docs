...
description: "Legacy POP3 text getter retained for compatibility."
...
**Prototype:** vuPOP3GetPassword(), CSTRING, PROC, PASCAL, RAW, NAME('vuPOP3GetPassword')

## Description
Gets pop3 password text using the original vuMail compatibility behavior.
