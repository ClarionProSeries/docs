...
description: "Gets SMTP user, password, security type, and SSL flag from runtime globals. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
