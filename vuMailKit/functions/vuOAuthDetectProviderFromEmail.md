...
summary: "Detects whether an email address maps to a supported OAuth provider."
description: "Detects whether an email address maps to a supported OAuth provider and returns provider, recommended auth mode, and reason text."
