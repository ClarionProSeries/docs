...
description: "Legacy vuMail function name. This function is an alias for vuSmtpSetFromReplyTo() and behaves identically. Use vuSmtpSetFromReplyTo() for new development. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
