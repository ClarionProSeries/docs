...
summary: "Launches the verification URL from BeginLogin and optionally copies the device code to clipboard."
description: "Launches the verification URL from BeginLogin and optionally copies the device code to clipboard. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
