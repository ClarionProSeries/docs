...
description: "Gets the current runtime CodePage text using the legacy vuMail compatibility pattern."
...
**Prototype:** vuGlobalsGetCodePage(), CSTRING, PROC, PASCAL, RAW, NAME('vuGlobalsGetCodePage')
