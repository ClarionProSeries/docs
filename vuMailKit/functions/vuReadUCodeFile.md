...
description: "Legacy UCode file-read helper retained for compatibility."
...
**Prototype:** vuReadUCodeFile(*CSTRING InFileName), CSTRING, PROC, PASCAL, RAW, NAME('vuReadUCodeFile')
