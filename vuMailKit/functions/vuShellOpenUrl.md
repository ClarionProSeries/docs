...
description: "Opens a URL using the Windows shell and returns diagnostics. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
