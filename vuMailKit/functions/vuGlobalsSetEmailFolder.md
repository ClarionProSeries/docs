...
summary: "Sets the runtime folder path used for saving email files."
description: "Sets the runtime folder path used for saving email files. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
keywords: ["vuMailKit", "vuMail", "vuglobalssetemailfolder", "vusetsavefolder"]
