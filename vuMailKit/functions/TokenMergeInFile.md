---
title: "TokenMergeInFile"
summary: "Reads text from a source file, replaces token text, and writes the merged result to a target file."
description: "TokenMergeInFile reads text from a source file, replaces token text, and writes the merged result to a target file."
keywords: ["vuMailKit", "token merge", "search and replace", "TokenMergeInFile", "Clarion"]
function_name: "TokenMergeInFile"
