---
title: "Send a Form-Letter Invoice Email with an Optional Personal Message"
summary: "Combine a branded HTML frame, fixed form-letter text, simple token values, and generated invoice content in one polished email."
description: "Build a reusable invoice email template with fixed form-letter wording, optional personal-message space, and a generated invoice section, then merge it all together with vuMailKit TokenMerge helpers."
keywords: ["vuMailKit", "invoice email", "form letter", "TokenMerge", "TokenMergeFileIntoFile", "Clarion"]
page_type: "guide"
