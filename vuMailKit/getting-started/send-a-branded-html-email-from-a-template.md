---
title: "Send a Branded HTML Email from a Template"
summary: "Use an external HTML frame plus TokenMerge to create branded email without damaging the original template."
description: "Create a reusable HTML email template with a logo, footer, and body tokens, then merge Clarion-generated content into a separate output file before sending with vuMailKit."
keywords: ["vuMailKit", "TokenMerge", "TokenMergeFileIntoFile", "HTML template", "logo", "letterhead", "Clarion"]
page_type: "guide"
