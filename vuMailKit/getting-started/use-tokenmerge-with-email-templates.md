---
title: "Use TokenMerge with Email Templates"
summary: "Replace named tokens in text, HTML, memory buffers, and external files before sending the message."
description: "Use TokenMergeInString, TokenMergeInFile, and TokenMergeFileIntoFile to personalize external templates, in-memory bodies, and generated Clarion report output before sending email with vuMailKit."
keywords: ["vuMailKit", "TokenMerge", "mail merge", "templates", "Clarion", "invoice"]
page_type: "guide"
