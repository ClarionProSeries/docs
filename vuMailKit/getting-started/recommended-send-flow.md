---
title: "Recommended Send Flow with a Stored Profile"
summary: "A practical Clarion button-handler pattern for checking setup, offering the Email Setup Wizard, validating the recipient, sending mail, and showing useful diagnostics."
description: "Recommended production-style send flow for vuMailKit Clarion applications using a saved profile from the vuMailKit Email Setup Wizard. Shows how to check for a stored profile, offer the wizard, validate the To address, send mail, and handle common return codes."
keywords: ["vuMailKit", "Clarion", "send flow", "stored profile", "setup wizard", "OAuth", "return codes", "email validation"]
page_type: "guide"
