---
title: "vuMailKit Email Setup Wizard"
summary: "Import and use the vuMailKit Email Setup Wizard to validate an address, detect provider settings, handle OAuth when needed, send a test email, and save a reusable profile."
description: "How Clarion developers import and use the vuMailKit Email Setup Wizard. The wizard validates the email address, detects provider settings, handles OAuth authorization when enabled, sends a test email, and saves a working profile."
keywords: ["vuMailKit", "Email Setup Wizard", "Clarion", "CTRL+U", "utility template", "OAuth", "profile", "autodetect", "SMTP", "POP3"]
page_type: "guide"
