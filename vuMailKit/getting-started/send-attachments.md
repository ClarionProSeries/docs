...
summary: "Attach one file, several files, or a wildcard set of files to an outgoing email."
description: "Use the attachment parameter on vuSendMail or vuSendMailWait to send one file, multiple files, or wildcard-selected files with outgoing email."
keywords: ["vuMailKit", "attachments", "Clarion", "email", "vuSendMailWait"]
page_type: "guide"
