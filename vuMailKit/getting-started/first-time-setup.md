...
summary: "Add the template, import the vuMailKit Email Setup Wizard with CTRL+U, compile the EXE, send a test email, and save a working profile."
description: "The simplest first-time setup path for vuMailKit: add the template to the EXE app, enter the quoted license string, import the vuMailKit Email Setup Wizard with CTRL+U, compile, run the vuMailKit Email Setup Wizard, test the connection, save the profile, and start sending mail."
keywords: ["vuMailKit", "wizard", "setup", "profile", "Clarion", "license", "multi-DLL"]
page_type: "guide"
