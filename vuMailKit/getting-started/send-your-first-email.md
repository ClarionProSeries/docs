...
summary: "The quickest path to sending email once licensing is initialized and a profile is saved."
description: "Use the vuMailKit Email Setup Wizard, save a profile, and send your first vuMailKit email with the simplest practical workflow."
keywords: ["vuMailKit", "send email", "Clarion", "profile", "license"]
page_type: "guide"
