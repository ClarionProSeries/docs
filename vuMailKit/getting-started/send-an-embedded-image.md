---
title: "Send an Embedded Image"
summary: "Show images inside the HTML email body instead of only sending them as normal attachments."
description: "Use Simple HTML with normalized body text and the embed-attachments marker, external HTML files, local or remote img src values, and Simple HTML header/footer images to include inline images in an HTML email."
keywords: ["vuMailKit", "embedded image", "HTML email", "Clarion", "inline image", "CID", "_embed attachments_", "remote image", "Simple HTML", "NormalizeBody"]
page_type: "guide"
