...
description: "Clears stored OAuth state/tokens for a provider/account pair. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
