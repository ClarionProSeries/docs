...
description: "Detects OAuth provider and auth mode from an email address. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
