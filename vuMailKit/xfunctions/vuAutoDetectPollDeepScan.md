---
title: "vuAutoDetectPollDeepScan"
summary: "Poll an asynchronous deep autodetect job for state, stage, and status text."
description: "Checks the current state of a previously started deep autodetect job and returns status information that a Clarion wizard or progress screen can display. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "autodetect", "deep scan", "poll", "status", "vuAutoDetectPollDeepScan"]
function_name: "vuAutoDetectPollDeepScan"
category: "Autodetect"
