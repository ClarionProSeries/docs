...
description: "Explains the preferred vuMailKit function naming scheme, how it groups related functions, and how it relates to legacy vuMail names. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
