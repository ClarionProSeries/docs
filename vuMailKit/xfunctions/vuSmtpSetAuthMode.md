...
description: "Sets SMTP authentication mode to password or OAuth. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
