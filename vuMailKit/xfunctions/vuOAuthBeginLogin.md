...
description: "Starts OAuth login and returns provider-specific callback or device-verification text. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
