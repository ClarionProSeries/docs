---
title: "vuMailToA"
summary: "Opens the default mail client using a mailto: URI and includes an attachment hint parameter."
description: "Opens the default mail client using a mailto: URI and includes an attachment hint parameter. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vumailtoa"]
function_name: "vuMailToA"
...
MAP
  MODULE('vuMail.dll')
    vuMailToA(*CSTRING xTo,*CSTRING xCc,*CSTRING xBcc,*CSTRING xSubject,*CSTRING xBody,*CSTRING xAttachment),LONG,PASCAL,RAW,NAME('vuMailToA')
  END
END
