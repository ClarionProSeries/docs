...
summary: "Release stored state for a deep autodetect job after you are finished with it."
description: "Deletes the DLL-side state associated with a previously started deep autodetect job so the handle can no longer be polled or queried. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "autodetect", "deep scan", "release", "vuAutoDetectReleaseDeepScan"]
