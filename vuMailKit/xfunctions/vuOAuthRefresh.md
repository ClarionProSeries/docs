...
description: "Requests an OAuth token refresh for a provider/account pair. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
