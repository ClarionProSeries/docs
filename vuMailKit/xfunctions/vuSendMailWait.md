...
description: "Queues one email and waits for SMTP processing to finish. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
