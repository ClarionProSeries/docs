...
description: "Gets the outbound SMTP server name and port. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
