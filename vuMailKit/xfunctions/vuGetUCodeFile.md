...
description: "Legacy UCode path helper retained for compatibility. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
