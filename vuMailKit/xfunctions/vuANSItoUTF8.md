---
title: "vuANSItoUTF8"
summary: "Legacy ANSI-to-UTF8 conversion helper retained for compatibility."
description: "Legacy ANSI-to-UTF8 conversion helper retained for compatibility. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vuansitoutf8"]
function_name: "vuANSItoUTF8"
...
```Prototype
vuANSItoUTF8(*CSTRING xInput), CSTRING
```
...
## Parameters
- `xInput` (*CSTRING): ANSI input text.
