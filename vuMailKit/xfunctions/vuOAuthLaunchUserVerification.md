...
description: "Launches the verification URL from BeginLogin and optionally copies the device code to clipboard. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
