...
description: "Creates or truncates a CSV file and selects it for vuMailAppendCSV(). [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
