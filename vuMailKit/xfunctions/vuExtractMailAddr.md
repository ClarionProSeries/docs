---
title: "vuExtractMailAddr"
summary: "Legacy email-address parsing helper retained for compatibility."
description: "Legacy email-address parsing helper retained for compatibility. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vuextractmailaddr"]
function_name: "vuExtractMailAddr"
...
```Prototype
vuExtractMailAddr(*CSTRING xInput), CSTRING
```
