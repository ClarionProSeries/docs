...
description: "Exports the currently loaded legacy message to an .eml file. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
