...
description: "Completes an OAuth login after callback/device verification data is available. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
