---
title: "vuUTF8toANSI"
summary: "Legacy UTF8-to-ANSI conversion helper retained for compatibility."
description: "Legacy UTF8-to-ANSI conversion helper retained for compatibility. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vuutf8toansi"]
function_name: "vuUTF8toANSI"
...
```Prototype
vuUTF8toANSI(*CSTRING xInput), CSTRING
```
