...
description: "Appends one mail row to the currently selected legacy CSV file. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
