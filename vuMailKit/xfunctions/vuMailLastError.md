...
description: "Gets the current last-error text using the legacy vuMail compatibility pattern using the legacy pointer-to-CString compatibility pattern. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
