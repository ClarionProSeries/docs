...
description: "Selects an existing CSV file for subsequent vuMailAppendCSV() calls. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
