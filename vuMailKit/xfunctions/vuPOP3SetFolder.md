...
summary: "Sets the POP3 folder name in memory."
description: "Sets the POP3 folder name used by vuMailKit POP3 operations. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "POP3", "vupop3setfolder"]
...
```Prototype
vuPOP3SetFolder(*CSTRING), LONG
```

## Description
Sets the POP3 folder name stored in the live runtime configuration.
