---
title: "vuAutoDetectStartDeepScan"
summary: "Start an asynchronous deep autodetect job and receive a scan handle you can poll from Clarion."
description: "Starts the long-running deep autodetect pipeline in the background and returns a positive handle when the job was created successfully. Use the returned handle with vuAutoDetectPollDeepScan(), vuAutoDetectGetDeepScanResult(), vuAutoDetectCancelDeepScan(), and vuAutoDetectReleaseDeepScan(). [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "autodetect", "deep scan", "async", "scan handle", "vuAutoDetectStartDeepScan"]
function_name: "vuAutoDetectStartDeepScan"
category: "Autodetect"
