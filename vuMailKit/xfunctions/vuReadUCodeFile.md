---
title: "vuReadUCodeFile"
summary: "Legacy UCode file-read helper retained for compatibility."
description: "Legacy UCode file-read helper retained for compatibility. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vureaducodefile"]
function_name: "vuReadUCodeFile"
...
```Prototype
vuReadUCodeFile(*CSTRING xFilePath), CSTRING
```
...
## Parameters
- `xFilePath` (*CSTRING): Full path of the file to read.
