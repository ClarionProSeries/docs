---
title: "vuPOP3GetUser"
summary: "Returns POP3 user ID using the legacy vuMail text-return style."
description: "Returns POP3 user ID using the legacy vuMail text-return style. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vupop3getuser"]
function_name: "vuPOP3GetUser"
...
```Prototype
vuPOP3GetUser(), CSTRING
```

## Description
Returns the POP3 user ID currently stored in the live runtime configuration.
