...
summary: "Returns message subject using the legacy vuMail text-return style."
description: "Returns message subject using the legacy vuMail text-return style. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
...
```Prototype
vuPOP3GetSubject(), CSTRING
```

## Description
Returns the subject of the message currently loaded into the POP3 message buffer.
