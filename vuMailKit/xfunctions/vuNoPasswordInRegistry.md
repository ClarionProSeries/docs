...
summary: "Controls whether the SMTP password is omitted from legacy registry persistence."
description: "Controls whether the SMTP password is omitted when legacy global settings are written through the old vuMail registry model. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "vunopasswordinregistry", "registry", "password", "legacy"]
