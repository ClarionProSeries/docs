---
title: "AboutGlobalMemory"
summary: "Explains how vuMailKit uses live runtime settings, legacy global storage, and managed profiles."
description: "Describes how vuMailKit keeps settings in memory while your program is running, how legacy global save/load behavior works, and how that behavior changes after a managed profile is created. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "globals", "runtime", "registry", "profile", "configuration", "Clarion"]
function_name: "AboutGlobalMemory"
category: "Concepts"
version_added: "1.0"
