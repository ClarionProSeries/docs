---
title: "vuPOP3SetUser"
summary: "Sets the POP3 user ID in memory."
description: "Sets the POP3 user ID used by vuMailKit POP3 operations. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "POP3", "vupop3setuser"]
function_name: "vuPOP3SetUser"
...
```Prototype
vuPOP3SetUser(*CSTRING), LONG
```

## Description
Sets the POP3 user ID stored in the live runtime configuration.
...
RC = vuPOP3SetUser('charles@example.com')
```
