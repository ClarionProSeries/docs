...
summary: "Requests a return receipt for the next send operation."
description: "Requests a return receipt for the next email sent through vuMailKit. [All functions](index.md) | [Legacy functions](legacy-index.md) | [About function names](AboutFunctionNames.md)"
keywords: ["vuMailKit", "vuMail", "return receipt", "read receipt", "vurequestreceipt"]
