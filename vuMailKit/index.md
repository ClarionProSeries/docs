---
title: "vuMailKit"
summary: "Basic edition documentation root files for vuMailKit."
...
This documentation covers the current vuMailKit Basic edition function set and the supporting setup, deployment, and usage notes needed by Clarion developers.
...
If you plan to use Microsoft 365, Outlook.com, Google, or Gmail accounts with OAuth sign-in, start here:
...
You can browse the function reference in two ways:
...
- Online docs (recommended): https://clarionproseries.github.io/docs/vuMailKit/
