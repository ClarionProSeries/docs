...
summary: "Sends a file to the specified printer after optionally waiting for the file to appear."
description: "Sends a file to the specified printer after optionally waiting for the file to appear."
keywords: ["vuprinttoexistsex", "print", "named printer", "wait", "poll", "vuFileTools", "Clarion"]
