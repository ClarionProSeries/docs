...
description: "Function reference pages for vuMailKit. [Home](../index.md) | [All functions](index.md) | [Legacy functions](legacy-index.md) | [Categories](../categories/index.md)"
...
| [AboutGlobalMemory](AboutGlobalMemory.md) | Explains vuMailKit runtime global memory and registry load/save behavior. |

## Global Variable Related

| Function | Description |
|---|---|
| [vuGlobalsLoad](vuGlobalsLoad.md) | Loads vuMailKit global settings from the Windows registry. |
| [vuGlobalsSave](vuGlobalsSave.md) | Saves vuMailKit global settings to the Windows registry. |
...
| [vuGetMailServerFolder](vuGetMailServerFolder.md) | Gets the folder where vuMailKit can save email files. |
...
| [vuMailFailureNotice](vuMailFailureNotice.md) | Requests a failure notice (delivery failure notification) for the next sent email. |
| [vuMailFromReplyTo](vuGetFromReplyTo.md) | Sets default From and Reply-To email addresses for outgoing mail. |
...
| [vuSuccessReceipt](vuRequestReceipt.md) | Requests a return receipt for the next sent email. |
| [vuValidateMailAddr](vuValidateMailAddr.md) | Validates a practical internet email address and rejects obvious malformed values. |
...
| [vuOAuthSmokeTest](vuOAuthSmokeTest.md) | Runs a minimal OAuth export-path smoke test. |
...
| [vuSetImageSize](vuSetImageSize.md) | Sets legacy image width/height hint values in runtime globals. |
