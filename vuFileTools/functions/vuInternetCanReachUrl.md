---
title: "vuInternetCanReachUrl"
summary: "Tests whether a specific URL can be reached within a timeout."
description: "Tests whether a specific URL can be reached within a caller supplied timeout using WinINet. Returns 1 when the URL is successfully opened, 0 on failure, and -1 on parameter or API setup errors."
keywords: ["vuFileTools", "networking", "internet", "connectivity", "vuInternetCanReachUrl", "HTTP", "Clarion", "Windows"]
function_name: "vuInternetCanReachUrl"
category: "Networking"
version_added: "5.0"
