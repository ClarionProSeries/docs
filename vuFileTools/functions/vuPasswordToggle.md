...
summary: "Programmatically toggles the visibility state of an initialized managed control."
description: "Switches a managed control between visible-text mode and normal masked mode. While the DLL manages an internal button for user interaction, this function allows for programmatic control. [Home](../index.md) | [All functions](index.md) | [Categories](../categories/index.md)"
keywords: ["vuFileTools", "password", "toggle", "show password", "hide password", "Clarion", "vuPasswordToggle"]
